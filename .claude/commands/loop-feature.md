...
4. **Chạy test suite thật:** the project's test command (none configured — infer from README/CI, or ask before assuming) (hoặc file test cụ thể vừa sửa). Không suy đoán kết quả — chạy và đọc output.
