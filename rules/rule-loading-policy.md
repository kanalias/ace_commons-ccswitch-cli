...
Global (`~/.claude/rules/`) luôn always mọi project — đó là bản chất tầng global (xem [[meta-2tier]]). Đừng gán `paths:` cho global. Muốn giảm global → chắt nội dung ngắn, ref chi tiết qua `[[...]]`, KHÔNG lazy-hoá.
