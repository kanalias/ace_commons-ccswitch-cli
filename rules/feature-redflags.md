...
| "Task không cần test" | Không test = task chưa xong. ≥1 happy + ≥1 edge/error, cùng commit. |
...
| "File ngoài scope đọc tham khảo thôi" | Đọc = vi phạm scope isolation. Cần thật → dừng, hỏi user whitelist. |
...
| "Code trước plan đỡ phí thời gian" | Code trước plan = rework. Đợi plan approve. |
